...
public class TicketRepositoryImpl implements TicketRepository {
    ...
    public Attachment getAttachment(long ticketId, String name) {
        final String SQL_SELECT_ATTACHMENT = "select * from attachment where ticket_id=? and filename=?";
        return jdbcOp.queryForObject(SQL_SELECT_ATTACHMENT, new AttachmentRowMapper(), ticketId, name);
    }
